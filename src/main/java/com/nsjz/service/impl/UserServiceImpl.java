...
import com.nsjz.mapper.UserMapper;
...
import static com.nsjz.contant.UserConstant.USER_LOGIN_STATU;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    private static final String SALT = "nsjz";
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        // 4. 记录用户的登录态
        request.getSession().setAttribute(USER_LOGIN_STATU, safetyUser);
        return safetyUser;
    ...
    public int userLogout(HttpServletRequest request) {
        // 移除登录态
        request.getSession().removeAttribute(USER_LOGIN_STATU);
        return 1;
